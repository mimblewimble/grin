...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		prev_root: Hash::from_hex(
			"0000000000000000000654251e0c5569fb3090ee075d6064384a9cf5b5825e2a",
		)
		.unwrap(),
		...
		kernel_root: Hash::from_hex(
			"ce8d7adf7980ea59721ec67c53abd7ac638d68dbcb173325f1f56dc9d083e863",
		)
		.unwrap(),
		...
		pow: ProofOfWork {
			...
			proof: Proof {
				nonces: vec![
					20525247, 22142994, 25512322, 28944909, 40417878, 51066060, 56670341, 65687141,
					66617867, 91326207, 127803804, 130810582, 136972782, 160824767, 163671392,
					167713936, 213570447, 227508667, 227904973, 233428575, 233553075, 236144762,
					253010457, 256542389, 299329090, 309426567, 313551080, 319634802, 329546633,
					342401254, 363671855, 375068579, 388968263, 396508833, 406487812, 430328776,
					461250127, 477612019, 499991679, 510547627, 526624150, 535470036,
				],
				edge_bits: 29,
			},
		},
	...
	let kernel = core::TxKernel {
		...
		excess_sig: Signature::from_raw_data(&[
			245, 36, 223, 159, 36, 101, 171, 94, 42, 165, 124, 70, 82, 151, 82, 109, 16, 97, 131,
			129, 229, 206, 174, 160, 172, 254, 13, 39, 92, 154, 167, 6, 253, 217, 31, 3, 151, 246,
			39, 188, 198, 176, 134, 153, 113, 215, 159, 232, 226, 4, 130, 199, 204, 246, 13, 52,
			178, 224, 95, 108, 19, 87, 213, 67,
		])
		.unwrap(),
	};
