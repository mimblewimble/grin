...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		height: 0,
timestamp: Utc.ymd(2018, 12, 28).and_hms(19, 3, 3),
prev_root: Hash::from_hex("0000000000000000000654251e0c5569fb3090ee075d6064384a9cf5b5825e2a").unwrap(),
output_root: Hash::from_hex("73b5e0a05ea9e1e4e33b8f1c723bc5c10d17f07042c2af7644f4dbb61f4bc556").unwrap(),
range_proof_root: Hash::from_hex("667a3ba22f237a875f67c9933037c8564097fa57a3e75be507916de28fc0da26").unwrap(),
kernel_root: Hash::from_hex("ce8d7adf7980ea59721ec67c53abd7ac638d68dbcb173325f1f56dc9d083e863").unwrap(),
...
nonce: 102,
			proof: Proof {
nonces: vec![20525247, 22142994, 25512322, 28944909, 40417878, 51066060, 56670341, 65687141, 66617867, 91326207, 127803804, 130810582, 136972782, 160824767, 163671392, 167713936, 213570447, 227508667, 227904973, 233428575, 233553075, 236144762, 253010457, 256542389, 299329090, 309426567, 313551080, 319634802, 329546633, 342401254, 363671855, 375068579, 388968263, 396508833, 406487812, 430328776, 461250127, 477612019, 499991679, 510547627, 526624150, 535470036],
				edge_bits: 29,
			},
		},
		..Default::default()
...
mod test {
	...
	fn floonet_genesis_hash() {
		...
		assert_eq!(
			gen_hash.to_hex(),
			"245292a6d6220c71d27be446735fa7746cb4d117079330be0b94423b8d1f6aa5"
		);
		assert_eq!(
			gen_bin.hash().to_hex(),
			"70cae08117a65463060ef886eb3d6ae979853c48d5aa1d11da5a09b19da3920a"
		);
	}
