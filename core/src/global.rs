...
pub fn get_genesis_nonce() -> u64 {
	...
	match *param_ref {
		...
		MiningParameterMode::UserTesting => 22141,  /* Magic nonce for current genesis block at
		                                              * cuckoo16 */
		MiningParameterMode::Production => 1429942738856787200, /* Magic nonce for current
		                                                         * genesis at cuckoo30 */
	}
}
