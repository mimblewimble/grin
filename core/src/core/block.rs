...
pub enum Error {
	...
	CoinbaseSumMismatch,
	/// A block must contain a single coinbase kernel.
	CoinbaseKernelCount,
	/// A block must contain a single coinbase output.
	CoinbaseOutputCount,
