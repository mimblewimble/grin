...
use {
	...
	NullWalletCommAdapter, NodeClient
};
...
pub fn owner_api(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, g_args: &GlobalArgs) -> Result<(), Error> {
...
pub fn account(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, args: AccountArgs) -> Result<(), Error> {
...
pub fn send(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, args: SendArgs) -> Result<(), Error> {
...
pub fn receive(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, g_args: &GlobalArgs, args: ReceiveArgs) -> Result<(), Error> {
...
pub fn finalize(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, args: FinalizeArgs) -> Result<(), Error> {
	let adapter = FileWalletCommAdapter::new();
	let mut slate = adapter.receive_tx_async(&args.input)?;
	controller::owner_single_use(wallet.clone(), |api| {
		if let Err(e) = api.verify_slate_messages(&slate) {
...
pub fn outputs(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, g_args: &GlobalArgs, dark_scheme: bool) -> Result<(), Error> {
	controller::owner_single_use(wallet.clone(), |api| {
...
pub fn repost(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, args: RepostArgs) -> Result<(), Error> {
	controller::owner_single_use(wallet.clone(), |api| {
...
pub fn cancel(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>, args: CancelArgs) -> Result<(), Error> {
	controller::owner_single_use(wallet.clone(), |api| {
...
pub fn restore(wallet: Arc<Mutex<WalletInst<impl NodeClient + 'static, keychain::ExtKeychain>>>) -> Result<(), Error> {
	controller::owner_single_use(wallet.clone(), |api| {
