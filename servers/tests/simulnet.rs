...
pub fn create_wallet(
	...
	let mut wallet: LMDBBackend<HTTPWalletToNodeClient, HTTPWalletToWalletClient, keychain::ExtKeychain> =
...
fn replicate_tx_fluff_failure() {
	...
	let wallet1 = create_wallet("target/tmp/tx_fluff/wallet1", client1.clone(), client1_w.clone());
	...
	let wallet2 = create_wallet("target/tmp/tx_fluff/wallet2", client2.clone(), client2_w.clone());
