...
fn get_tip(base_addr: &String, api_server_port: u16) -> Result<api::Tip, Error> {
	...
	api::client::get::<api::Tip>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
fn get_status(base_addr: &String, api_server_port: u16) -> Result<api::Status, Error> {
	...
	api::client::get::<api::Status>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
fn get_block_by_height(
	...
	api::client::get::<api::BlockPrintable>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
fn get_block_by_height_compact(
	...
	api::client::get::<api::CompactBlockPrintable>(url.as_str(), false, "")
...
fn get_outputs_by_ids1(
	...
	api::client::get::<Vec<api::Output>>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
fn get_outputs_by_height(
	...
	api::client::get::<Vec<api::BlockOutputs>>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
fn get_txhashset_roots(base_addr: &String, api_server_port: u16) -> Result<api::TxHashSet, Error> {
	...
	api::client::get::<api::TxHashSet>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
fn get_txhashset_lastoutputs(
	...
	api::client::get::<Vec<api::TxHashSetNode>>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
pub fn ban_peer(base_addr: &String, api_server_port: u16, peer_addr: &String) -> Result<(), Error> {
	...
	api::client::post_no_ret(url.as_str(), false, "", &"").map_err(|e| Error::API(e))
}
...
pub fn get_peer(
	...
	api::client::get::<p2p::PeerData>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
pub fn get_connected_peers(
	...
	api::client::get::<Vec<p2p::PeerInfo>>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
...
pub fn get_all_peers(
	...
	api::client::get::<Vec<p2p::PeerData>>(url.as_str(), false, "").map_err(|e| Error::API(e))
}
