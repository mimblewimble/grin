...
fn main() {
    ...
    .subcommand(SubCommand::with_name("server")
                ...
                .arg(Arg::with_name("port")
                     ...
                     .takes_value(true))
                .arg(Arg::with_name("private_api_port")
                     .short("pa")
                     .long("private_api_port")
                     .help("Port on which to start the private api server")
                     .takes_value(true))
                .arg(Arg::with_name("public_api_port")
                     .short("a")
                     .long("public_api_port")
                     .help("Port on which to start the public api server (e.g. transaction pool api)")
                     .takes_value(true))
